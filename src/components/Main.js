...
class ControllerUnitComponent extends React.Component {
	...
	render() {
		...
		return (
			<span className={controllerUnitClass} onClick={this.handleClick.bind(this)}>
...
class AppComponent extends React.Component {
	...
	render() {
		...
		imageDatas.forEach(function(value, index) {
			...
			imgFigures.push(<ImgFigureComponent key={index} data = {value} ref = {'image' + index} arrange = {this.state.imgsArrangeArr[index]} inverse = {this.inverse(index)} center = {this.center(index)} />);
			controllerUnits.push(<ControllerUnitComponent key={index} data = {value} arrange = {this.state.imgsArrangeArr[index]} inverse = {this.inverse(index)} center = {this.center(index)} />);
		}.bind(this));
		return (
